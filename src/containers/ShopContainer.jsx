...
const ShopContainer = (props) => {
    ...
    const updateFilter = (filterObj) => {
        ...
        const checkedCategories = _.compact(_.map(filterObj.categories, (categoryFilter) => categoryFilter.checked === true ? categoryFilter : null))
        if (checkedCategories && checkedCategories.length) {

            const filteredProd = _.compact(_.map(products, (prod) => {
